...
func (c *userClient) UserLogin(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*UserLoginReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.valuation.v1.User/UserLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_UserLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.valuation.v1.User/UserLogin",
	}
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.valuation.v1.User",
	...
	Metadata: "valuation/v1/user.proto",
}
